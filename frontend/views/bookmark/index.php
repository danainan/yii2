            ...
            <div class="col-lg-10 offset-lg-1">
                ...
                <div class="cart_items">
                    <?php foreach ($bookmark as $model) {
                        $movies = Movies::findOne(new MongoDB\BSON\ObjectID($model->movies_id));
                    ?>
                        <ul class="cart_list">
                            <li class="cart_item clearfix">
                                <div class="cart_item_image"><img src="<?= $movies->movie_img ?>" alt=""></div>
                                <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                    <div class="col-4">
                                        <div class="cart_item_title">Movie name</div>
                                        <td class="cart_item_text"><?= $movies->movie_name ?></td>
                                    </div>
                                </div>
                            </li>
                        </ul>
