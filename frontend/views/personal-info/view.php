...
<div class="personal-info-view">
    ...
    <!-- <?php echo Html::encode($this->title);?> เทียบเท่า code ด้านล่าง
            ...
            <div class="card border-0 shadow h-100">
                ...
                <div class="card-body p-1-9 p-xl-5 mb-5">
                    ...
                    <ul class="list-unstyled mb-4">
                        <li class="mb-4"><a href="mailto:<?=$model->e_mail?>"><i class="far fa-envelope display-25 me-3 text-secondary col-2"></i><?= $model->e_mail?></a></li>
            ...
            <div class="text-start mb-1-6 wow fadeIn">
                    ...
                    <div class="row mt-4 ">
                        ...
                        <div class="col-2 mt-4">
                            ...
                            <span class="font-weight-light ">Birth of Date </span><br/>
